    ...
    <footer className="border-t border-white/5 bg-background">
      <div className="mx-auto max-w-7xl px-4 py-12 md:px-6">
        <div className="grid grid-cols-2 gap-8 md:grid-cols-4">
          ...
          {/* Leistungen */}
          <div>
            <h4 className="mb-3 text-sm font-medium">Leistungen</h4>
          ...
          {/* Unternehmen */}
          <div>
            <h4 className="mb-3 text-sm font-medium">Unternehmen</h4>
            <ul className="space-y-2">
          ...
          {/* Kontakt & Rechtliches */}
          <div>
            <h4 className="mb-3 text-sm font-medium">Kontakt</h4>
            <ul className="space-y-2">
              <li>
                <Link
                  href="/kontakt"
        ...
        <div className="mt-10 border-t border-white/5 pt-6 text-center text-sm text-muted-foreground">
          © {new Date().getFullYear()} Hoba Automation. Alle Rechte vorbehalten.
        </div>
      </div>
    </footer>
  );
