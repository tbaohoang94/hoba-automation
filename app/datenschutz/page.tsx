    ...
    <section className="py-20 md:py-28" style={{ background: "var(--bg-light)" }}>
      <div className="mx-auto max-w-[1280px] px-4 md:px-6">
        <div className="mx-auto max-w-3xl">
          <h1 className="text-4xl font-bold tracking-tight text-[var(--text-on-light)]">
            Datenschutzerklärung
          </h1>
          <p className="mt-4 text-[var(--text-on-light-muted)]">
            Stand: Februar 2026
          </p>

          <div className="mt-10 space-y-10 text-[var(--text-on-light-secondary)] leading-relaxed">
            {/* 1. Verantwortlicher */}
            <div>
